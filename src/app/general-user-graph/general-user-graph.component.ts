...
@Component({
  selector: 'app-general-user-graph',
  templateUrl: './general-user-graph.component.html',
  styleUrls: ['./general-user-graph.component.css']
})
export class GeneralUserGraphComponent implements OnInit {
